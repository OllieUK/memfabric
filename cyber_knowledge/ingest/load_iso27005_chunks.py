#!/usr/bin/env python3
"""load_iso27005_chunks.py — Load reviewed iso27005_inspection.yaml into the knowledge graph.

Reads the reviewed YAML produced by inspect_iso27005.py and:
...
Usage:
    python3 -m scripts.load_iso27005_chunks [--yaml scripts/iso27005_inspection.yaml]
                                             [--dry-run]
"""
...
def _classify_statement_type(fw_id: str, body: str | None) -> str | None:
    """Rule-based statement type classification for ISO 27005 clauses."""
    if not body:
        return "structural"
    ...
    # ISO 27005 uses "should" for guidance recommendations — map to "informative"
...
def main() -> None:
    ...
    parser.add_argument("--yaml", default="scripts/iso27005_inspection.yaml")
