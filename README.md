...
python3 -m uvicorn memory_service.main:app --reload --log-config memory_service/logging.ini
```
...
- API health: https://memfabric.carr-it.net/health
...
open https://memfabric.carr-it.net/docs
```
