"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.build_inspector_notebook.
...
_warnings.warn(
    "scripts/build_inspector_notebook.py path has moved to cyber_knowledge/ingest/build_inspector_notebook.py (WP-173). "
    "Update imports to `from cyber_knowledge.ingest.build_inspector_notebook import ...` "
    "and invocations to `python -m cyber_knowledge.ingest.build_inspector_notebook`.",
    DeprecationWarning,
    stacklevel=2,
)
...
from cyber_knowledge.ingest import build_inspector_notebook as _target  # noqa: E402
