"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.document.
...
_warnings.warn(
    "scripts/ingest_document.py has moved to cyber_knowledge/ingest/document.py (WP-173). "
    "Update imports to `from cyber_knowledge.ingest.document import ...` "
    "and invocations to `python -m cyber_knowledge.ingest.document`.",
    DeprecationWarning,
    stacklevel=2,
)
...
from cyber_knowledge.ingest import document as _target  # noqa: E402
...
if __name__ == "__main__":
    from cyber_knowledge.ingest.document import main as _main  # noqa: E402
    _main()
