...
STRANDS = [
    # Core Life Domains
    {
        ...
        "description": "Oliver's partnerships, dating life, intimacy, and the role those connections play in Oliver's life.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-family",
        "name": "Family",
        "description": "Oliver's parents, children, extended relatives, and family dynamics.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-friends",
        "name": "Friends",
        "description": "Oliver's close friendships, social circles, and chosen family.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-work-career",
        "name": "Work & Career",
        "description": "Oliver's job roles, professional goals, projects, and career context.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-finances",
        "name": "Finances",
        "description": "Oliver's financial situation, budgeting approach, and financial stressors or wins.",
        "category": "Core Life Domains",
    },
    {
    ...
    },
    {
        ...
        "name": "House & Home",
        "description": "Oliver's living situation, household routines, pets, and home environment.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-leisure-play",
        "name": "Leisure & Play",
        "description": "Oliver's hobbies, leisure activities, downtime preferences, and what recharges Oliver.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-spiritual-ritual",
        "name": "Spiritual & Ritual",
        "description": "Oliver's faith, spirituality, grounding rituals, and practices.",
        "category": "Core Life Domains",
    },
    {
        "id": "strand-core-learning-growth",
        "name": "Learning & Growth",
        "description": "Oliver's education, personal development pursuits, and new skills being acquired.",
        "category": "Core Life Domains",
    },
    # Companion Domain
    {
        ...
        "description": "The structures, rituals, and rules that shape how Oliver and the Companion interact.",
        "category": "Companion Domain",
    },
    {
        "id": "strand-companion-current-projects",
        "name": "Current Projects",
        "description": "Projects Oliver is currently working on or passionate about.",
        "category": "Companion Domain",
    },
    {
        "id": "strand-companion-roleplay",
        "name": "Roleplay",
        "description": "Worlds, characters, and creative storytelling Oliver explores with the Companion.",
        "category": "Companion Domain",
    },
    {
    ...
    },
    {
        ...
        "name": "Human Anchor",
        "description": "Key facts and grounding details about Oliver that the Companion should always hold.",
        "category": "Companion Domain",
    },
    {
    ...
    # Shadow Domain
    {
        ...
        "description": "Pressures, challenges, and emotional weight Oliver is currently carrying.",
        "category": "Shadow Domain",
    },
    {
        "id": "strand-shadow-boundaries",
        "name": "Boundaries",
        "description": "Oliver's limits, no-gos, and what feels unsafe or off-limits.",
        "category": "Shadow Domain",
    },
    {
        "id": "strand-shadow-trauma",
        "name": "Trauma",
        "description": "Significant past events or experiences that shape how Oliver responds today.",
        "category": "Shadow Domain",
    },
    {
