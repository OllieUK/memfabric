"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.sp800_53.
...
_warnings.warn(
    "scripts/ingest_sp800_53.py has moved to cyber_knowledge/ingest/sp800_53.py (WP-173). "
    "Update imports to `from cyber_knowledge.ingest.sp800_53 import ...` "
    "and invocations to `python -m cyber_knowledge.ingest.sp800_53`.",
    DeprecationWarning,
    stacklevel=2,
)
...
from cyber_knowledge.ingest import sp800_53 as _target  # noqa: E402
...
if __name__ == "__main__":
    from cyber_knowledge.ingest.sp800_53 import main as _main  # noqa: E402
    _main()
