"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.framework.
...
from cyber_knowledge.ingest import framework as _target  # noqa: E402
...
if __name__ == "__main__":
    from cyber_knowledge.ingest.framework import main as _main  # noqa: E402
    _main()
