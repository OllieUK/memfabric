"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.attack.
...
_warnings.warn(
    "scripts/ingest_attack.py has moved to cyber_knowledge/ingest/attack.py (WP-173). "
    "Update imports to `from cyber_knowledge.ingest.attack import ...` "
    "and invocations to `python -m cyber_knowledge.ingest.attack`.",
    DeprecationWarning,
    stacklevel=2,
)
...
from cyber_knowledge.ingest import attack as _target  # noqa: E402
...
if __name__ == "__main__":
    from cyber_knowledge.ingest.attack import main as _main  # noqa: E402
    _main()
