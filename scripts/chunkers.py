"""Deprecation shim — WP-173. Moved to cyber_knowledge.ingest.chunkers.
...
_warnings.warn(
    "scripts/chunkers.py path has moved to cyber_knowledge/ingest/chunkers.py (WP-173). "
    "Update imports to `from cyber_knowledge.ingest.chunkers import ...` "
    "and invocations to `python -m cyber_knowledge.ingest.chunkers`.",
    DeprecationWarning,
    stacklevel=2,
)
...
from cyber_knowledge.ingest import chunkers as _target  # noqa: E402
