...
def test_existing_ask_entries_unchanged(settings):
    ...
    original_33 = [
        ...
        "Edit(/home/oliver/projects/graph-memory-fabric/cyber_knowledge/ingest/schema_init.py)",
        ...
        "Write(/home/oliver/projects/graph-memory-fabric/cyber_knowledge/ingest/schema_init.py)",
